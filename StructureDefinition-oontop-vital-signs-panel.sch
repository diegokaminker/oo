...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:hasMember) &gt;= 4">hasMember: minimum cardinality of 'hasMember' is 4</sch:assert>
      <sch:assert test="count(f:hasMember) &lt;= 4">hasMember: maximum cardinality of 'hasMember' is 4</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
